...
Public Class NewPatient
    Public mintPaitentID As String
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        If mintSave = 0 Then
            DB.AddNewPatient(txtPatFN.Text, txtPatLN.Text, txtPatAddress.Text, txtPatZip.Text, txtPatPhone.Text, ddlMonth.SelectedItem.ToString & "/" & ddlDay.SelectedItem.ToString & "/" & ddlYear.SelectedItem.ToString, txtPatDriversLis.Text, txtPatSSN.Text, ddlGender.SelectedItem.ToString, txtPatCity.Text, ddlPatState.SelectedItem.ToString, rtbComments.Text, mintNumberOfRelatives, intEmployerID)
            MessageBox.Show(txtPatFN.Text & " " & txtPatLN.Text & " has been added to the database!", "Patient Added!", MessageBoxButtons.OK)
            mintSave += 1
            DisableForm()
        Else
            DB.UpdatePatientInfo(txtPatFN.Text, txtPatLN.Text, txtPatAddress.Text, txtPatZip.Text, txtPatPhone.Text, ddlMonth.SelectedItem.ToString & "/" & ddlDay.SelectedItem.ToString & "/" & ddlYear.SelectedItem.ToString, txtPatDriversLis.Text, txtPatSSN.Text, ddlGender.SelectedItem.ToString, txtPatCity.Text, ddlPatState.SelectedItem.ToString, rtbComments.Text, mintPaitentID)
