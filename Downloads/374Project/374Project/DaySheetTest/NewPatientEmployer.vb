...
Public Class NewPatientEmployer
    ...
    Private Sub btnSave_Click(sender As System.Object, e As System.EventArgs) Handles btnSave.Click
        ...
        If txtEmpPhone.Text <> "" Then
            If Len(txtEmpPhone.Text) < 9 Then
        ...
        If txtSpouseEmpPhone.Text <> "" Then
            If Len(txtSpouseEmpPhone.Text) < 9 Then
        ...
        If txtNRPhone.Text <> "" Then
            If Len(txtNRPhone.Text) < 9 Then
                MessageBox.Show("Nearest relative phone must be at least 9 numbers.")
                Exit Sub
            End If
        End If
        ...
        DB.AddEmployerID(intEmployerID.ToString, intPatientID)
        ...
        If txtSpouseFN.Text <> "" Then
            If mintEmployerSave = 0 Then
                DB.AddNewSpouse(txtSpouseFN.Text, txtSpouseLN.Text, ddlSpouseGender.SelectedItem.ToString, txtSpouseEmpPhone.Text, intPatientID, intSpouseEmployerID)
            Else
