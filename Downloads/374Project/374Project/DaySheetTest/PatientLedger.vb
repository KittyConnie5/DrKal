Public Class PatientLedger
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        If txtEmployer.Text <> "" Then
            ...
            If DB.CountDataset.Tables("tblPatient").Rows.Count > 0 Then
        ...
        'input changes to DB
        DB.UpdatePatientInfo(txtPatFN.Text, txtPatLN.Text, txtPatAddress.Text, txtPatZip.Text, txtTelephone.Text, txtDOB.Text, txtDriversLiscense.Text, txtSSN.Text, ddlGender.SelectedItem.ToString, txtPatCity.Text, ddlPatState.SelectedItem.ToString, rtbComments.ToString, intPatientID)
